...
LastEditTime : 2021-07-25 17:33:29
Email        : quzhenqing@zju.edu.cn
Description  : monte-carlo-tree-search 解决[选择数字使累加和为0的游戏]
...
class State(object):
  ...
  def get_available_choices(self):
    # 选出还没用过的choice
    return [choice for choice in ALL_AVAILABLE_CHOICES if choice not in self.cumulative_choices]

  def get_next_state_with_random_choice(self):
    random_choice = random.choice(ALL_AVAILABLE_CHOICES)
    next_state = State()
